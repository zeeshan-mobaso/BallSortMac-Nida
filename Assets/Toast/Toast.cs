...
public class Toast : MonoBehaviour
{
    ...
    [SerializeField] Text toast_title, toast_description;
    [SerializeField] GameObject toast_panel;
    ...
    {
        //AToast aToast = new AToast(title, time);
        //queue.Enqueue(aToast);

        //Debug.LogError("showing message");

        toast_title.text = title;
        toast_description.text = description;
        toast_panel.SetActive(true);
